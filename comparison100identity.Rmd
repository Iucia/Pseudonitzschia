...
Note: All sequences have length >380 bp [[it's sequence length and not query cover?]]:
...
[**] Note:
MC reference has 24 species (27 sequences); 22 out of 24 are detected here. The ones missing are *P. multiseries* in its "single" version (not the one in the ID3 cluster), and *P. pseudodelicatissima*.
